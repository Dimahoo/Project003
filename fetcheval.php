...
$columns = array('id','id_interv','interv','trimestre','year','note','com');
$request=$_REQUEST;
$col =array(
    0   =>  'id',
    1   =>  'id_interv',
...
$sql = "SELECT * FROM eval WHERE 1=1";
...
if(isset($_POST["search"]["value"])){
    ...
    $sql.=" OR year Like '".$_POST["search"]["value"]."%' ";
    $sql.=" OR note Like '".$_POST["search"]["value"]."%' ";
    $sql.=" OR com Like '".$_POST["search"]["value"]."%' )";
}
$query=mysqli_query($con,$sql);
$totalData=mysqli_num_rows($query);
//Order
